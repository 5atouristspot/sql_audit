...
def alter():
    ...
    try:
        ...
        database = request.args.get('database', type=str, default='')
        sql_statment = request.args.get('sql_statment', type=unicode, default="")
        ...
        sql_audit = "/*--user={user};--password={passwd};--host={ip_info};--enable-execute;--port={port};*/" \
