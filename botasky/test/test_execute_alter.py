...
class AlterExample(unittest.TestCase):
    '''
    def test_execute_alter_ok(self):
        ok_request = requests.get(url='http://192.168.74.95:3621/api/v1000/execute/alter',
                                  params={'port': '4450', 'database': 'inception_test', 'sql_statment': "alter TABLE user_dept_relation add content_html11 longtext COMMENT 'H5';"})
    ...
    def test_execute_alter_port_fail(self):
        fail_request = requests.get(url='http://192.168.74.95:3621/api/v1000/execute/alter',
    ...
    '''
    def test_execute_alter_database_fail(self):
        fail_request = requests.get(url='http://192.168.74.95:3621/api/v1000/execute/alter',
    ...
    '''
    def test_execute_alter_sql_statment_fail(self):
        fail_request = requests.get(url='http://192.168.74.95:3621/api/v1000/execute/alter',
